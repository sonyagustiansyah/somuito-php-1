...
<head>
  ...
  <title>Hubungi Kami - PT. Somuito</title>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            ...
            <select class="form-select" aria-label="Pilih Bahasa" onchange="location = this.value;">
                <option value="hubungi.php" selected>ID</option>
                <option value="../../en/hubungi/hubungi.php">EN</option>
                <option value="../../zh/hubungi/hubungi.php">CN</option>
            </select>
            </div>
        </div>
        </div>
      ...
      <div class="row">
        ...
        <div class="col-md-4 mb-3">
          ...
          <ul class="list-unstyled">
            ...
            <li style="font-size: 14px;"><a href="hubungi.php">Hubungi Kami</a></li>
          </ul>
        </div>
