...
// --- Hitung total data
$count_sql = "SELECT COUNT(*) AS total FROM brake_pads_premium $where";
$count_res = $conn->query($count_sql);
$total_data = $count_res->fetch_assoc()['total'];
$total_pages = ceil($total_data / $limit);

// --- Ambil data
$sql = "SELECT * FROM brake_pads_premium $where LIMIT $limit OFFSET $offset";
...
<!-- Navbar -->
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        ...
        <div class="d-flex">
          <select class="form-select" aria-label="Pilih Bahasa" onchange="location = this.value;">
            <option value="brake_pads.php" selected>ID</option>
            <option value="../../en/produk/brake_pads.php">EN</option>
            <option value="../../zh/produk/brake_pads.php">CN</option>
          </select>
        </div>
      </div>
    </div>
  ...
  <br><br><br><br><br>
    ...
    <h2 class="mb-4 text-center">Brake Pads Premium</h2>
    ...
    <!-- Deskripsi Produk -->
    <p>Brake Pad mobil berbahan semi-metallic dirancang untuk memberikan daya cengkeram kuat dan tahan panas tinggi, ideal untuk mobil yang sering digunakan di medan berat atau perjalanan jauh. Material logam berkualitas membuat performa pengereman lebih responsif, meski menghasilkan debu lebih banyak. Dengan durabilitas tinggi dan harga kompetitif, Somuito menjadi pilihan tepat bagi pengemudi yang mengutamakan keamanan dan performa maksimal.</p>
    ...
    <form method="get" class="row g-2 mb-3">
        ...
        <a href="brake_pads.php" class="btn btn-warning">Reset</a>
        </div>
    </form>
