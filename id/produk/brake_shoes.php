...
// --- Hitung total data
$count_sql = "SELECT COUNT(*) AS total FROM brake_shoes_premium $where";
$count_res = $conn->query($count_sql);
$total_data = $count_res->fetch_assoc()['total'];
$total_pages = ceil($total_data / $limit);

// --- Ambil data
$sql = "SELECT * FROM brake_shoes_premium $where LIMIT $limit OFFSET $offset";
...
<head>
  <meta charset="UTF-8">
  <title>Brake Shoes Premium - PT. Somuito</title>
  <meta name="description" content="Brake Shoes Premium Somuito - kampas rem mobil berkualitas tinggi, OEM replacement untuk Toyota, Daihatsu, Mitsubishi, Suzuki, dan lainnya.">
  <meta name="keywords" content="kampas rem, brake shoes, somuito, OEM brake shoes, kampas rem toyota, kampas rem daihatsu, kampas rem suzuki">
...
<!-- Navbar -->
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        ...
        <div class="d-flex">
          <select class="form-select" aria-label="Pilih Bahasa" onchange="location = this.value;">
            <option value="brake_shoes.php" selected>ID</option>
            <option value="../../en/produk/brake_shoes.php">EN</option>
            <option value="../../zh/produk/brake_shoes.php">CN</option>
          </select>
        </div>
      </div>
    </div>
  ...
  <br><br><br><br><br>
    ...
    <h2 class="mb-4 text-center">Brake Shoes Premium</h2>

    <!-- Gambar Produk -->
    <div class="text-center mb-4">
        <img src="../../assets/gambar/product3.webp" alt="Brake Shoes Premium" loading="lazy" class="img-fluid rounded shadow" width="1400">
    </div>

    <!-- Deskripsi Produk -->
    <p>Brake Shoe Somuito berbahan semi-metallic dirancang untuk memberikan daya cengkeram kuat dan performa pengereman optimal. Material logam berkualitas membuatnya tahan panas serta awet digunakan, cocok untuk kendaraan dengan beban kerja tinggi maupun pemakaian jarak jauh. Dengan durabilitas tinggi dan harga kompetitif, Somuito Semi-Metallic Brake Shoe menjadi pilihan tepat bagi pengemudi yang mengutamakan keamanan dan ketahanan maksimal.</p>
    ...
    <form method="get" class="row g-2 mb-3">
        ...
        <a href="brake_shoes.php" class="btn btn-warning">Reset</a>
        </div>
    </form>
