...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $stmt = $conn->prepare("INSERT INTO brake_pads_premium (brand_mobil, nama_mobil, description, genuine_number, posisi) VALUES (?, ?, ?, ?, ?)");
...
<head>
  <meta charset="UTF-8">
  <title>Tambah Brake Pads Premium</title>
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        ...
        <div class="d-flex">
          <select class="form-select" aria-label="Pilih Bahasa" onchange="location = this.value;">
            <option value="add_brake_pads.php" selected>ID</option>
            <option value="../../en/produk/add_brake_pads.php">EN</option>
            <option value="../../zh/produk/add_brake_pads.php">CN</option>
          </select>
        </div>
      </div>
    </div>
...
<div class="container mt-5">
  <h2 class="mb-4 text-center">Tambah Brake Pads Premium</h2>
